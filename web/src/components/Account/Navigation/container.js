...
class NavigationContainer extends Component {
  ...
  constructor(props) {
    ...
    this.state = {
      ...
      pages: [
        { key: 'account-overview', url: '/', active: false, visible: true },
        { key: 'account-weekley', url: '/weekley', active: false, visible: true },
        { key: 'users', url: '/users', active: false, visible: authService.hasRole('USER_MANAGER') },
        { key: 'my-profile', url: '/profile', active: false, visible: true }
      ],
      showLngList: false,
